...
TEST("pputl.gen.any: generates args by repeating the result of gen(idx, ...?) "
     "[0, 256) times") {
  static_assert(streq(STR(PPUTL_GEN_ANY(0, SIMPLEGEN)), ""));
  static_assert(streq(STR(PPUTL_GEN_ANY(1, SIMPLEGEN)), "v0"));
  static_assert(streq(STR(PPUTL_GEN_ANY(2, SIMPLEGEN)), "v0, v1"));
  static_assert(streq(STR(PPUTL_GEN_ANY(3, SIMPLEGEN)), "v0, v1, v2"));
  static_assert(streq(STR(PPUTL_GEN_ANY(4, SIMPLEGEN)), "v0, v1, v2, v3"));
  static_assert(streq(
  ...
  static_assert(streq(STR(PPUTL_GEN_ANY(0, CUSTOMGEN, _)), ""));
  static_assert(streq(STR(PPUTL_GEN_ANY(1, CUSTOMGEN, _)), "_0"));
  static_assert(streq(STR(PPUTL_GEN_ANY(2, CUSTOMGEN, _)), "_0, _1"));
  static_assert(streq(STR(PPUTL_GEN_ANY(3, CUSTOMGEN, _)), "_0, _1, _2"));
  static_assert(streq(STR(PPUTL_GEN_ANY(4, CUSTOMGEN, _)), "_0, _1, _2, _3"));
  static_assert(streq(
