...
TEST("pputl.cat: concatenate [0, 256) args") {
  static_assert(streq(STR(PPUTL_CAT()), ""));
  static_assert(PPUTL_CAT(1) == 1);
  static_assert(PPUTL_CAT(1, 2) == 12);
  static_assert(PPUTL_CAT(1, 2, 3) == 123);
  static_assert(PPUTL_CAT(12, 3) == 123);
  static_assert(PPUTL_CAT(1, 23) == 123);
  static_assert(PPUTL_CAT(1, 23) == 123);
  static_assert(streq(
      STR(PPUTL_CAT(
