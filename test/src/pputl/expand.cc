...
TEST("pputl.and: performs a secondary expansion of the provided args") {
  static_assert(streq(STR(THREESUM EXPAND_ME()), "THREESUM (1, 2, 3)"));
  static_assert(streq(STR(PPUTL_EXPAND(THREESUM EXPAND_ME())), "1 + 2 + 3"));
};
