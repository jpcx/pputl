...
constexpr char const project_header[]{
    ...
    "//                                                                            //\n"
    "//    note: integral enum examples are based on default configuation.         //\n"
    "//                                                                            //\n"
    "//     any: any individual argument in a __VA_ARGS__ expression               //\n"
    "//      ├╴none: literal nothing; an absence of pp-tokens                      //\n"
    "//      ├╴tup:  an indexable collection of generic items                      //\n"
    "//      │  └╴pair: a two-tuple [e.g. (foo, bar)]                              //\n"
    "//      │     └╴kv: a word-keyed value [e.g. (42, zzyzx)]                     //\n"
    "//      ├╴sym: a sequence of digit|nondigit tokens (see C++20 lex.name)       //\n"
    "//      │  ├╴enum<v...>: a symbol matching a defined enumeration              //\n"
    ...
    "//      │  └╴word:  int|uint; a word-sized integer                            //\n"
    "//      │     ├╴size: any non-negative word up to size_max                    //\n"
    "//      │     └╴ofs:  any word whose abs. val is a valid size                 //\n"
    "//      ├╴obj: a named, sized, indexable collection of items                  //\n"
    "//      │  ├╴null: an empty object for base derivation                        //\n"
    "//      │  ├╴arr:  an iterable, sized item sequence                           //\n"
    "//      │  │  ├╴ord:   a sorted array of words or kv pairs                    //\n"
    "//      │  │  ├╴stack: a LIFO stack of generic items                          //\n"
    "//      │  │  ├╴queue: a FIFO queue of generic items                          //\n"
    "//      │  │  └╴heap:  a min or max heap of words or kv pairs                 //\n"
    "//      │  │     └╴pq: a priority queue of generic items                      //\n"
    "//      │  └╴set: a set of words or kv pairs                                  //\n"
    "//      │     └╴map: a map of words to generic items                          //\n"
    "//      └╴range: tup|arr; an indexable collection of items                    //\n"
    "//                                                                            //\n"
    "//    FUNDAMENTALS                                                            //\n"
    "//    ------------                                                            //\n"
    "//                                                                            //\n"
    "//    All types are fully detectable except for sym, which requires tokens    //\n"
    "//    to match a digit|nondigit sequence /[\\w\\d]+/ in order to concatenate  //\n"
    "//    with identifiers to form new identifiers. traits.is_sym and type.sim    //\n"
    "//    cannot fully guarantee validity but can exclude none, tup and obj.      //\n"
    "//                                                                            //\n"
    "//    User-defined types may be created by calling the obj constructor, by    //\n"
    "//    using type.derive on an existing object instance,  or by creating an    //\n"
    "//    enum.  obj names (passed to obj and derive)  cannot have any leading    //\n"
    "//    underscores, and enum keys cannot be words (they are reserved).         //\n"
    "//                                                                            //\n"
