...
constexpr char const project_header[]{
    ...
    "//    recursion, custom objects, and a vector type.                           //\n"
    "//                                                                            //\n"
    ...
    "//         ├╴obj: an atom-addressable state container                         //\n"
    ...
    "//            └╴sym:  an explicitly defined atom                              //\n"
    "//               └╴word: a C++ int expression matching a predefined set       //\n"
