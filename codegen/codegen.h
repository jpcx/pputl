...
constexpr char const project_header[]{
    ...
    "//    many language constructs  including a primitive type system,  signed    //\n"
    "//    and unsigned integers, errors, recursion, and stateful objects.         //\n"
    "//                                                                            //\n"
    ...
    "//                                                                            //\n"
    "//    The default build defines a 12-bit word size, which is configurable     //\n"
    "//    in the generation framework. However, care must be taken when using     //\n"
    "//    integers as indices, as the maximum size of a tuple is dependent on     //\n"
    "//    the maximum number of macro function parameters. The C++20 standard     //\n"
    "//    guarantees a lower bound of 256, but some compilers may allow more.     //\n"
    "//                                                                            //\n"
    ...
    "//         ├╴sym: a global or namespace-qualified name                        //\n"
