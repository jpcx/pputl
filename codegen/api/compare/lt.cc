...
//   };
// 
//   def zip = def{"zip(" + utl::cat(utl::alpha_base52_seq(conf::bit_length * 2), ", ")
//                 + ")"} = [&](pack args) {
...
//     return first(utl::cat(std::vector<std::string>(conf::bit_length, recur + "(")) + "0, 0, "
//                  + zip(args) + utl::cat(std::vector<std::string>(conf::bit_length, ")")));
//   };
// 
//   def<"icmp(lb, rb)"> icmp = [&](arg lb, arg rb) {
//     def<"00(...)"> _00 = [&](va args) {
//       return ucmp(args);
//     };
// 
...
//       return ucmp(args);
//     };
//     return pp::call(cat(utl::slice(_00, -2), cat(esc(ifirst + " " + lb), esc(ifirst + " " + rb))),
//                     esc + " " + lb, esc + " " + rb);
//   };
// 
...
//                           return icmp(pp::tup(bits(l)), pp::tup(bits(r)));
//                         };
// 
