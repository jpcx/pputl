...
#define PTL_BUILD /* -> <c++ int> */ 20220826
...
/// PTL_BSLL(1, 12)    // 0
/// PTL_BSLL(1, 13)    // 0
#define PTL_BSLL(/* word, n: idec */...) /* -> word */ PPUTLBSLL_o(__VA_ARGS__)
...
#define PTL_BSRL(/* word, n: idec */...) /* -> word */ PPUTLBSRL_o(__VA_ARGS__)
...
#define PTL_BSRA(/* word, n: idec */...) /* -> word */ PPUTLBSRA_o(__VA_ARGS__)

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - {{{

#define PPUTLBSRA_o(v, ct) \
  PTL_WORD(PPUTLBSRA_oo(PTL_IDEC(ct), PTL_BDUMP(PTL_WORD(v))), PTL_TYPEOF(v))
...
#define PTL_SWITCH(/* size, ...cases: tup */...) /* -> list */                          \
  PPUTLSWITCH_RES(PPUTLSWITCH_X(PTL_RECUR_LP(PTL_FIRST(__VA_ARGS__), PPUTLSWITCH_RECUR) \
