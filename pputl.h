...
#define PPUTLIMPL_ARITHHINT(/* INT|UINT, INT|UINT */ a, b) /* -> INT|UINT */ \
  PPUTLIMPL_ARITHHIN##a##b

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - {{{

#define PPUTLIMPL_ARITHHINT_UINTUINT UINT
#define PPUTLIMPL_ARITHHINT_UINTINT  UINT
#define PPUTLIMPL_ARITHHINT_INTUINT  UINT
#define PPUTLIMPL_ARITHHINT_INTINT   INT
