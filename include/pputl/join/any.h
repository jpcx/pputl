#ifndef PPUTL_JOIN_ANY_H_INCLUDED
#define PPUTL_JOIN_ANY_H_INCLUDED
#/////                                                                     c++20
#///////////////////////////////////////////////////////////////////////////////
#/// @brief \link PPUTL_JOIN_ANY PPUTL_JOIN_ANY\endlink -
...
#/// joins [0, 256) args using a joining function
#///
#/// @param   joining_fn macro in the form of F(a, b) -> [joined token]
#/// @param   ... args to join
...
#
#define PPUTL_DETAIL_JOIN_REDUCER(a, v, i) \
  (PPUTL_TUPLE_ELEM(0, a), PPUTL_TUPLE_ELEM(0, a)(PPUTL_TUPLE_ELEM(1, a), v))
#
...
#/*                                                                                                                                                        */ // clang-format on
#define PPUTL_DETAIL_JOIN_REDUCE_CHOICE(                                       \
    ...
    size, ...)                                                                 \
  PPUTL_DETAIL_JOIN_REDUCE_CAT(PPUTL_DETAIL_JOIN_REDUCE_, size)
#
