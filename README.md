# pputl 0.2.2 | [_API Docs_](http://jpcx.github.io/pputl/group__pputl.html) | [_CHANGELOG_](https://github.com/jpcx/pputl/blob/0.2.2/CHANGELOG.md)
...
All API features are statically tested with [jpcx/cctest](https://github.com/jpcx/cctest) (embedded).
